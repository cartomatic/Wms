        ...
        )
        {
            cfg
                .EnableSwagger(c =>
                {
                    ...
                    //
                    c.SingleApiVersion("v1", "Cartomatic.Wms.ManifoldWmsDriverWebApi");
                    ...
                    //
                    c.IncludeXmlComments(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"bin\Cartomatic.Wms.ManifoldWmsDriverWebApi.xml"));
